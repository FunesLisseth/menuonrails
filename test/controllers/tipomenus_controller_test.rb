...
class TipomenusControllerTest < ActionController::TestCase
  ...
  test "should create tipomenu" do
    assert_difference('Tipomenu.count') do
      post :create, tipomenu: { description: @tipomenu.description, idtipo: @tipomenu.idtipo, name: @tipomenu.name }
    end
  ...
  test "should update tipomenu" do
    patch :update, id: @tipomenu, tipomenu: { description: @tipomenu.description, idtipo: @tipomenu.idtipo, name: @tipomenu.name }
    assert_redirected_to tipomenu_path(assigns(:tipomenu))
  end
