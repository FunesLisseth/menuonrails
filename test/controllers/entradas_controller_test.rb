...
class EntradasControllerTest < ActionController::TestCase
  ...
  test "should create entrada" do
    assert_difference('Entrada.count') do
      post :create, entrada: { description: @entrada.description, identrada: @entrada.identrada, name: @entrada.name }
    end
  ...
  test "should update entrada" do
    patch :update, id: @entrada, entrada: { description: @entrada.description, identrada: @entrada.identrada, name: @entrada.name }
    assert_redirected_to entrada_path(assigns(:entrada))
  end
